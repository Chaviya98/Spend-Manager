...
public class DateTimeCalculations {
    ...
    public func getRemainingTime(_ start: Date, end: Date) -> Int {
    ...
    public func getTimeDifference(_ start: Date, end: Date) -> (Int, Int, Int) {
        let difference: TimeInterval? = end.timeIntervalSince(start)
...
//    public func getAssignmentProgress(_ tasks: [Task]) -> Int {
